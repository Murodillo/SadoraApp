...
object AuditActions {
    ...
    const val DOCTOR_APPLIED = "doctor.applied"
    const val DOCTOR_APPROVED = "doctor.approved"
    const val DOCTOR_REJECTED = "doctor.rejected"
    const val DOCTOR_SUSPENDED = "doctor.suspended"
    const val DOCTOR_REINSTATED = "doctor.reinstated"
