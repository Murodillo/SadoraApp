...
/** The original. The other two languages are translated from this text, which governs. */
object LegalTextsUz : LegalTexts {

    override val effectiveDate = "3-sentabr, 2026"
    override val translationNotice: String? = null

    override val termsTitle = "Foydalanish shartlari"
    override val privacyTitle = "Maxfiylik siyosati"
    ...
    override val terms = listOf(
        ...
        LegalSection(
            "9. Bog'lanish",
            listOf(
                "Savollar bo'yicha: support@sadora.app",
            ),
        ),
    )
    ...
    override val privacy = listOf(
        ...
        LegalSection(
            "7. Bog'lanish",
            listOf(
                "Maxfiylik bo'yicha savollar: privacy@sadora.app",
            ),
        ),
    )
}
