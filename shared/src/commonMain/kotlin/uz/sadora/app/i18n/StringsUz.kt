...
object StringsUz : Strings {
    ...
    override val community = object : CommunityStrings {
        ...
        override val deletePostConfirm = "Ha, butunlay o'chirilsin"
    ...
    override val mind = object : MindStrings {
        ...
        override val moodNotLogged = "Bugun qanday his qilyapsiz?"
    ...
    override val journey = object : JourneyStrings {
        ...
        override val periodEndedThisDay = "Hayz shu kuni tugadi"
    ...
    override val modules = object : ModuleStrings {
        ...
        override fun perDayCount(count: Int) = "$count/kun"
        override fun perMonthCount(count: Int) = "$count/oy"
        override fun soum(amount: String) = "$amount so'm"
        ...
        override val cameraDenied = "Kameraga ruxsat berilmagan"
        override val cameraDeniedBody = "Taomni shu yerda suratga olish uchun sozlamalarda kamerani yoqing. Galereyadan surat tanlash yoki qo'lda kiritish ruxsatsiz ham ishlaydi."
        override val cameraOpenSettings = "Sozlamalarni ochish"
        override val cameraMissing = "Kamera ochilmadi. Galereyadan surat tanlang yoki qo'lda kiriting."
        ...
        override val portionLess = "Porsiyani kamaytirish"
